-- Atomic credit deduction: decrements by 1, enforces balance >= 0
...
-- Add unique constraint on articles source_url if not already present
-- (needed for upsert onConflict: 'source_url')
do $$
begin
  if not exists (
